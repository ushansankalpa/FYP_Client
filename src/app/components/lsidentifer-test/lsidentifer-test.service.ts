...
export class LsidentiferTestService {
    constructor(private http: HttpClient) {

    }

    testResult(data: any, user_id:any): Observable<EntityResponseType> {
        return this.http.post<any>(`${environment.apiUrl}/questionary/result/${user_id}`, data, { observe: 'response' });
    }
